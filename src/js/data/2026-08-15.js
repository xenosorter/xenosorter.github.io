dataSetVersion = "2026-08-15"; // Change this when creating a new data set version. YYYY-MM-DD format.
dataSet[dataSetVersion] = {};
// TODO: Change duplicate boolean to string that specifies who is duplicated so duped characters that do not have their dupes included are still included?
...
dataSet[dataSetVersion].characterData = [
  ...
  },
  {
    name: "MOMO",
    imgUrls: ["XS-MOMO.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/MOMO",
    opts: {
      role: ["protag"],
      series: ["XS"]
    }
  ...
  {
    name: "MOMO (XC2)",
    imgUrls: ["XC2-MOMO-Real.png", "XC2-MOMO-Imaginary.png"],
    wiki: "https://www.xenoserieswiki.org/wiki/MOMO",
    opts: {
      role: ["2blade"],
      series: ["XC2"],
